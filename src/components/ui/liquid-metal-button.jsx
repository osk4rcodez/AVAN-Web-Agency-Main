    ...
    <div className="relative inline-block">
      <div style={{ perspective: "1000px", perspectiveOrigin: "50% 50%" }}>
        ...
        >
          ...
          >
            {viewMode === "icon" && (
              <Sparkles size={16} style={{ color: "#4C2E7A", filter: "drop-shadow(0px 1px 2px rgba(255,255,255,0.6))", transition: "all 0.8s cubic-bezier(0.34, 1.56, 0.64, 1)", transform: "scale(1)" }} />
            )}
            {viewMode === "text" && (
              <span
                style={{
          ...
          >
            <div
              style={{
                ...
                boxShadow: isPressed
                  ? "inset 0px 2px 4px rgba(46,26,71,0.4), inset 0px 1px 2px rgba(46,26,71,0.3)"
                  : "none",
          ...
          >
            <div
              style={{
                ...
                borderRadius: "100px",
                boxShadow: isPressed
                  ? "0px 0px 0px 1px rgba(46,26,71,0.5), 0px 1px 2px 0px rgba(46,26,71,0.3)"
                  : isHovered
                    ? "0px 0px 0px 1px rgba(139,92,246,0.4), 0px 12px 6px 0px rgba(46,26,71,0.05), 0px 8px 5px 0px rgba(46,26,71,0.1), 0px 4px 4px 0px rgba(46,26,71,0.15), 0px 1px 2px 0px rgba(46,26,71,0.2)"
                    : "0px 0px 0px 1px rgba(139,92,246,0.3), 0px 36px 14px 0px rgba(46,26,71,0.02), 0px 20px 12px 0px rgba(46,26,71,0.08), 0px 9px 9px 0px rgba(46,26,71,0.12), 0px 2px 5px 0px rgba(46,26,71,0.15)",
                transition: "all 0.8s cubic-bezier(0.34, 1.56, 0.64, 1), width 0.4s ease, height 0.4s ease, box-shadow 0.15s cubic-bezier(0.4, 0, 0.2, 1)",

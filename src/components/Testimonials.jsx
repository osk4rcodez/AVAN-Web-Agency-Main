...
const placeholders = [
  {
    ...
    company: { de: 'Inspektion', en: 'Inspektion', pl: 'Inspektion' },
    quote: {
      ...
      pl: 'Chłopaki z AVAN wykonali naprawdę dobrą robotę dla Inspektion — szybko, niezawodnie i dokładnie tak, jak potrzebowaliśmy.',
    },
  },
  { id: 'b', initial: 'B', company: { de: 'Unternehmen B', en: 'Company B', pl: 'Firma B' } },
  { id: 'c', initial: 'C', company: { de: 'Unternehmen C', en: 'Company C', pl: 'Firma C' } },
]
    ...
    <section className="section">
      <div className="container-px">
        <div className="max-w-2xl">
          <p className="eyebrow mb-4">{t({ de: 'Referenzen', en: 'References', pl: 'Referencje' })}</p>
          <h2 className="text-3xl font-extrabold sm:text-4xl">
            {t({ de: 'Was unsere Kunden sagen.', en: 'What our clients say.', pl: 'Co mówią nasi klienci.' })}
          </h2>
          <p className="mt-4 text-lg leading-relaxed text-ink/70">
            {t({
              ...
              pl: 'Kolejne prawdziwe opinie pojawią się, gdy więcej projektów zostanie uruchomionych — nie startujemy ze zmyślonymi cytatami.',
            })}
          </p>
        </div>
          ...
          {placeholders.map((p, i) => (
            ...
            >
              ...
              <p className={`mt-4 flex-1 text-base leading-relaxed ${p.quote ? 'text-ink/80' : 'italic text-ink/45'}`}>
                {p.quote ? t(p.quote) : t({ de: 'Hier kommt dein Zitat.', en: 'Your quote goes here.', pl: 'Tu pojawi się Twój cytat.' })}
              </p>
              <div className="mt-6 flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-navy">
                    {p.name || t({ de: 'Name folgt', en: 'Name coming soon', pl: 'Nazwa wkrótce' })}
                  </p>

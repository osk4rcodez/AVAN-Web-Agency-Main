...
const INJECTED_STYLES = `
  ...
  .bg-grid-theme {
      ...
      background-image:
          linear-gradient(to right, rgba(46,26,71,0.06) 1px, transparent 1px),
          linear-gradient(to bottom, rgba(46,26,71,0.06) 1px, transparent 1px);
  ...
  .text-3d-matte {
      color: #2E1A47;
      text-shadow:
          0 10px 30px rgba(46,26,71,0.15),
          0 2px 4px rgba(46,26,71,0.08);
  }

  .text-silver-matte {
      background: linear-gradient(180deg, #2E1A47 0%, #8B5CF6 100%);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      background-clip: text;
      transform: translateZ(0);
      filter:
          drop-shadow(0px 10px 20px rgba(139,92,246,0.18))
          drop-shadow(0px 2px 4px rgba(46,26,71,0.10));
  }
...
export function CinematicHero({
  brandName = "AVAN",
  tagline1 = "Ihre Website.",
  tagline2 = "Unsere Verantwortung.",
  cardHeading = "Von der Idee bis zum Server.",
  cardDescription = (
    <>
      <span className="text-white font-semibold">AVAN</span> entwickelt, betreibt und
      betreut professionelle Websites für Unternehmen — Hosting, Pflege und Support aus
      einer Hand.
    </>
  ),
  metricValue = 100,
  metricLabel = "Betreut",
  ctaHeading = "Bereit für Ihre neue Website?",
  ctaDescription = "Lassen Sie uns in einem kurzen, unverbindlichen Gespräch besprechen, wie wir Ihnen helfen können.",
  className,
  ...props
}) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-screen h-screen overflow-hidden flex items-center justify-center bg-white text-[#2E1A47] font-sans antialiased", className)}
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 pb-[22vh] will-change-transform transform-style-3d">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#8B5CF6]/20 to-[#6D28D9]/5 flex items-center justify-center mr-3 border border-[#A78BFA]/20 shadow-inner">
                            <svg className="w-4 h-4 text-[#A78BFA] drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-[#8B5CF6]/20 to-[#6D28D9]/10 flex items-center justify-center border border-[#A78BFA]/30 shadow-inner">
                    <span className="text-base lg:text-xl drop-shadow-lg" aria-hidden="true">🚀</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Live online</p>
                    <p className="text-purple-200/50 text-[10px] lg:text-xs font-medium">Hosting aktiv</p>
                  </div>
                </div>
